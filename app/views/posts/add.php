                ...
                <div class="container px-5 py-24 mx-auto flex">
                    <div class=" flex flex-col mx-auto relative z-10 w-full md:w-9/12 lg:w-11/12 xl:w-9/12">
                        ...
                        <div class="flex flex-col justify-between sm:flex-row sm:flex-wrap  lg:flex-row ">
                            <div>
                                <input name="title" type="text" class="bg-white rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 " placeholder="Title" value="<?= htmlspecialchars($data['title']); ?>">
                            ...
                            <div>
                                <input name="price" type="number" class="bg-white rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 " placeholder="Price" value="<?= htmlspecialchars($data['price']); ?>">
                                <?php if (isset($data['title_err'])) : ?>
                                    <p class="text-red-500 text-xs italic mb-4"><?= $data['title_err']; ?></p>
                                <?php endif; ?>
                            </div>
                            ...
                            <div>
                                <input name="mileage" type="number" class="bg-white rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 " placeholder="Mileage" value="<?= htmlspecialchars($data['mileage']); ?>">
                            ...
                            <div>
                                <input name="cubic-capacity" type="number" class="bg-white rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base px-4 py-2" placeholder="Cubic capacity" value="<?= htmlspecialchars($data['cubic_capacity']); ?>">
                            ...
                            <div>
                                <input name="power" type="number" class="bg-white rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 " placeholder="Power" value="<?= htmlspecialchars($data['power']); ?>">
                            ...
                            <div>
                                <input name="fuel" type="text" class="bg-white rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 " placeholder="Fuel" value="<?= htmlspecialchars($data['fuel']); ?>">
                            ...
                            <div>
                                <input name="location" type="text" class="bg-white rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 " placeholder="Location" value="<?= htmlspecialchars($data['location']); ?>">
                                <?php if (isset($data['location_err'])) : ?>
                                    <p class="text-red-500 text-xs italic mb-4"><?= $data['location_err']; ?></p>
                                <?php endif; ?>
                            </div>
                            <div>
                                <input name="phone" type="number" class="bg-white rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 " placeholder="Phone number" value="<?= htmlspecialchars($data['phone_number']); ?>">
